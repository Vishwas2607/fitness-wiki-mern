  ...
  return (
    ...
    <header className='header flex justify-between items-center h-12 mb-6'>
      ...
      <AnimatePresence>
        ...
        aria-hidden={!isOpen}
        className='fixed top-0 left-0 z-10 body-text'
        >
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute/>}>
          ...
          <Route element={<ProtectedRouteAdmin />}>
              ...
              <Route path="/global-exercise/add-exercise" element={<AddExercise/>}/>
              <Route path="/global-exercise/edit-exercise/:id" element={<AddExercise/>}/>
          </Route>
